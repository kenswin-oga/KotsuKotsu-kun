        ...
        <div class="container mx-auto px-4 py-6 flex flex-col items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
                <div class="border rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        <h2 class="font-bold text-lg mb-2">{{ $recipeDataArray[0]['result'][0]['recipeTitle'] }}</h2>
                ...
                <div class="border rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        <h2 class="font-bold text-lg mb-2">{{ $recipeDataArray[1]['result'][0]['recipeTitle'] }}</h2>
                ...
                <div class="border rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        <h2 class="font-bold text-lg mb-2">{{ $recipeDataArray[2]['result'][0]['recipeTitle'] }}</h2>
